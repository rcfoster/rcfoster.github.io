# This code is to generate Table 2, simulation results for the gamma-Poisson model, in the paper. 
# It is essentially the file "Poisson-Gamma generalized KR simulation.R" but without the 
