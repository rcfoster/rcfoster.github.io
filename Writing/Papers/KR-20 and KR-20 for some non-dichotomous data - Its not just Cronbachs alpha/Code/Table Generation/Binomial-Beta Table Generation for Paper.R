# This code is to generate Table 5, simulation results for the beta-binomial model, in the paper. 
# It is essentially the file "Binomial-Beta generalized KR simulation.R" but without the 
