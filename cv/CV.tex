...
\begin{bibsection}
	\item \emph{Applications of Quantum Computing in Statistics}, Joint Statistical Metings, Aug. 2019 (Forthcoming)
\end{bibsection}

\section{Poster Sessions}
\begin{bibsection}
 \item \textbf{Foster, R.}, Vander Wiel, S., Livescu, V., and Bronkhorst, C., `Towards Random Generation of Microstructures of Spatially Varying Materials from Orthogonal Sections,' Computational Data Science Approaches for Materials 2019
\item \textbf{Foster, R.}, Weaver, B., Picard, R., and Gattiker, J., `Uncertainty, Noise, and Beyond Moore’s Law ,'' CoDA 2018 - Conference on Data Analysis
 \item \textbf{Foster, R.}, Vander Wiel, S., Livescu, V., and Bronkhorst, C., `Generation of Spatially Varying Digital Microstructures for Additively Manufactured Materials,' 2017 Materials Capability Review on Manufacturing Science
\end{bibsection}
